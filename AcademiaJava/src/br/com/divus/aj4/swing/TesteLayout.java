...
public class TesteLayout extends JFrame {
	...
	public TesteLayout(){
		...
		add(montarPainelFormulario(),BorderLayout.CENTER);
		add(montarPainelBotoes(),BorderLayout.SOUTH);//montarPainelBotoes();
		
		setLocationRelativeTo(null); // centralizar launch
		setVisible(true);
	}
