...
import br.com.divus.aj4.labs.lab02_02.br.com.globalcode.io.FiltroClientes;
...
public class ClientesDAOSerialization implements ClientesDAO {
	...
	public List<Cliente> getAllClientes() throws GlobalcodeException {
		...
		FilenameFilter filtro = new FiltroClientes(".ser");
		 ...
		 * 
		 */
		for (String arquivo : nomesArquivosFiltrados) {
