 ...
 */
package br.com.divus.aj4.labs.lab01_02.aj4.gui;
...
import br.com.divus.aj4.labs.lab01_02.util.GlobalcodeException;
...
public class PainelCadastroClientes extends JPanel {
	...
	private JPanel montaPanelBotoesCadastro() {
		 ...
		 */
		pBotoesCadastro.add(new JButton("Salvar"));
		pBotoesCadastro.add(new JButton("Cancelar"));
	...
	private JPanel montaPanelCadastroCliente() {
		...
		pCadastroCliente.setLayout(grid);
		
		pCadastroCliente.add(new JLabel("Nome"));
		pCadastroCliente.add(new JTextField());
