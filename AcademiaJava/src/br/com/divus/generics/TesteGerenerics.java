...
import br.com.divus.model.AbstractEntity;
...
public class TesteGerenerics {
	...
	public static void main(String[] args) {
		...
		salvarEmBatch(alunos, daoCliente);
	...
	public static void salvarEmBatch(List<? extends AbstractEntity> lista,
			IGerenericDAO dao){
		for (AbstractEntity entity : lista) {
			dao.salvar(entity);
