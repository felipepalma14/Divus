 ...
 * Academia do Java
 */
package br.com.divus.aj3.labs.lab03_03.er;

import java.util.regex.Matcher;
import java.util.regex.Pattern;

import br.com.divus.aj3.labs.lab03_03.util.Teclado;
...
public class TesteExpressaoRegular {
	public static void main(String args[]) {
		...
		if (validaNome(nome) && validaTelefone(telefone)) {
			...
			System.out
					.println("Nome deve de 5 a 20 caracteres entre letras e espacos.");
	...
	public static boolean validaTelefone(String telefone) {
		// Implemente a regra para validar o telefone tal que o formato aceito
		// seja:
