 ...
 * Academia do Java
 */
package br.com.divus.aj3.labs.lab03_02.teste;

import java.text.NumberFormat;
import java.util.Locale;

import br.com.divus.aj3.labs.lab03_02.banking.Investimento;
...
public class TesteNumberFormat {
	...
	public static void main(String[] args) {
		...
		NumberFormat formatador = NumberFormat.getNumberInstance(localidade);
